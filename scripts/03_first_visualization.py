...
# The dataset is generated by scripts/build_final_dataset.py
...
def main():
    ...
    # Save bar chart
    save_rating_bar_chart(df, 'rating_distribution.png')

    # Save pie chart
    save_rating_pie_chart(df, 'rating_pie_chart.png')

    print('Saved rating_distribution.png and rating_pie_chart.png')
